...
#' prepare an infographic-styled summary plot
#'
#' This method will prepare a graphical plot summarising user data with an emphasis on visualisation
#'
...
infoGraphicPlot4 <- function(identifier, panelA, panelB, panelC, panelD, reportDPI=90) {
  ...
  InfoGraphicValueBoxes <- ggplot(df, aes_string("x", "y", height = "h", width = "w", label = "key", fill = "colour")) +
