...
test_that("frankenFastq.fastq.gz can be fixed", {
  expect_equal(fastqValidator(fixFastq(system.file("extdata", "frankenFastq.fastq.gz", package = "nanopoRe", mustWork = TRUE), tempfile(pattern="fixfastq_", fileext=".fq"))), TRUE)
